...
# register_google(key = "")  #note you need a google key to make this part work
# 
# 
# ### Get a map
# map <- get_googlemap(center = c(lon = mean(longs), lat = mean(lats)), zoom = 8,
#                maptype = "satellite", source = "stamen", key = "") #note you need a google key to make this part work
# 
# FIG1 <- ggmap(map) +
